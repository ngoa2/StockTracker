    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file, 96, 1, 2064);
    			add_location(p, file, 97, 1, 2088);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "placeholder", "Search");
    			add_location(input, file, 102, 1, 2202);
    			add_location(button, file, 103, 1, 2271);
    			attr_dev(section, "class", "svelte-10n5a6g");
    			add_location(section, file, 106, 2, 2325);
    			attr_dev(div, "class", "svelte-10n5a6g");
    			add_location(div, file, 105, 1, 2317);
    			attr_dev(main, "class", "svelte-10n5a6g");
    			add_location(main, file, 94, 0, 2020);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
